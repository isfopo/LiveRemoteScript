...
class OscMessageBuilder(object):
    ...
    def args(self) -> List[Tuple[str, Union[str, bytes, bool, int, float, tuple, list]]]:
    ...
    # TODO: Make 'tuple' more specific for it is a MIDI packet
    def add_arg(self, arg_value: Union[str, bytes, bool, int, float, tuple, list], arg_type: str = None) -> None:
    ...
    # TODO: Make 'tuple' more specific for it is a MIDI packet
    def _get_arg_type(self, arg_value: Union[str, bytes, bool, int, float, tuple, list]) -> str:
